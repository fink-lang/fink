...
fn linked_runtime(interop: Interop) -> &'static LinkedRuntime {
  ...
  cell.get_or_init(|| {
    ...
    // Module URLs are all `rt/*.wat` — every runtime module is implementation,
    ...
    let modules: &[(&str, &str)] = &[
      ...
      ("rt/symbols.wat",   include_str!("../../runtime/symbols.wat")),
      ("rt/modules.wat",   include_str!("../../runtime/modules.wat")),
      ("rt/protocols.wat", include_str!("../../runtime/protocols.wat")),
      ("rt/num.wat",       include_str!("../../runtime/num.wat")),
      ("rt/str.wat",       include_str!("../../runtime/str.wat")),
      ("rt/list.wat",      include_str!("../../runtime/list.wat")),
      ("rt/int.wat",       include_str!("../../runtime/int.wat")),
      ("rt/float.wat",     include_str!("../../runtime/float.wat")),
      ("rt/decimal.wat",   include_str!("../../runtime/decimal.wat")),
      ("rt/libm.wat",      include_str!("../../runtime/libm.wat")),
      ("rt/math.wat",      include_str!("../../runtime/math.wat")),
      ("rt/range.wat",     include_str!("../../runtime/range.wat")),
      ("rt/set.wat",       include_str!("../../runtime/set.wat")),
      ("rt/dict.wat",      include_str!("../../runtime/dict.wat")),
