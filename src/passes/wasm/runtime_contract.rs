...
pub(super) fn import_key(sym: Sym) -> &'static str {
  match sym {
    ...
    Sym::OpDivMod        => "rt/protocols.wat:op_divmod",
    Sym::OpPow           => "rt/protocols.wat:op_pow",
    ...
    Sym::OpDisjoint      => "rt/protocols.wat:op_disjoint",
    ...
    Sym::OpRotL          => "rt/protocols.wat:op_rotl",
    Sym::OpRotR          => "rt/protocols.wat:op_rotr",
    ...
    Sym::ModulesInitModule => "rt/modules.wat:init_module",
  }
}
