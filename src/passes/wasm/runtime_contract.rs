...
fn import_key(sym: Sym) -> (&'static str, &'static str) {
  match sym {
    ...
    Sym::ArgsHead        => ("std/list.wat", "std/list.wat:args_head"),
    Sym::ArgsTail        => ("std/list.wat", "std/list.wat:args_tail"),
    Sym::ArgsEmpty       => ("std/list.wat", "std/list.wat:args_empty"),
    Sym::ArgsPrepend     => ("std/list.wat", "std/list.wat:args_prepend"),
    Sym::ArgsConcat      => ("std/list.wat", "std/list.wat:args_concat"),
    Sym::OpPlus          => ("rt/protocols.wat", "rt/protocols.wat:op_plus"),
    Sym::OpMinus         => ("rt/protocols.wat", "rt/protocols.wat:op_minus"),
    Sym::OpMul           => ("rt/protocols.wat", "rt/protocols.wat:op_mul"),
    Sym::OpDiv           => ("rt/protocols.wat", "rt/protocols.wat:op_div"),
    Sym::OpIntDiv        => ("rt/protocols.wat", "rt/protocols.wat:op_intdiv"),
    Sym::OpRem           => ("rt/protocols.wat", "rt/protocols.wat:op_rem"),
    Sym::OpIntMod        => ("rt/protocols.wat", "rt/protocols.wat:op_intmod"),
    Sym::OpEq            => ("rt/protocols.wat", "rt/protocols.wat:op_eq"),
    Sym::OpNeq           => ("rt/protocols.wat", "rt/protocols.wat:op_neq"),
    Sym::OpLt            => ("rt/protocols.wat", "rt/protocols.wat:op_lt"),
    Sym::OpLte           => ("rt/protocols.wat", "rt/protocols.wat:op_lte"),
    Sym::OpGt            => ("rt/protocols.wat", "rt/protocols.wat:op_gt"),
    Sym::OpGte           => ("rt/protocols.wat", "rt/protocols.wat:op_gte"),
    Sym::OpAnd           => ("rt/protocols.wat", "rt/protocols.wat:op_and"),
    Sym::OpOr            => ("rt/protocols.wat", "rt/protocols.wat:op_or"),
    Sym::OpXor           => ("rt/protocols.wat", "rt/protocols.wat:op_xor"),
    Sym::OpNot           => ("rt/protocols.wat", "rt/protocols.wat:op_not"),
    Sym::OpShl           => ("rt/protocols.wat", "rt/protocols.wat:op_shl"),
    Sym::OpShr           => ("rt/protocols.wat", "rt/protocols.wat:op_shr"),
    Sym::OpRngex         => ("std/range.wat", "std/range.wat:op_rngex"),
    Sym::OpRngin         => ("std/range.wat", "std/range.wat:op_rngin"),
    Sym::OpIn            => ("rt/protocols.wat", "rt/protocols.wat:op_in"),
    Sym::OpNotIn         => ("rt/protocols.wat", "rt/protocols.wat:op_notin"),
    ...
    Sym::Str             => ("std/str.wat", "std/str.wat:str"),
    Sym::StrEmpty        => ("std/str.wat", "std/str.wat:str_empty"),
    Sym::StrFmt          => ("std/str.wat", "std/str.wat:str_fmt"),
    Sym::StrMatch        => ("std/str.wat", "std/str.wat:str_match"),
    Sym::Yield           => ("std/scheduler.wat", "std/scheduler.wat:yield"),
    Sym::Spawn           => ("std/scheduler.wat", "std/scheduler.wat:spawn"),
    Sym::Await           => ("std/scheduler.wat", "std/scheduler.wat:await"),
